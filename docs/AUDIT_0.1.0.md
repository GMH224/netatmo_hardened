# Defect Audit 0.1.0 — Internal

**Audit series:** `AUDIT_0.1.0.md` (this document) · `AUDIT_0.1.1.md`
**Status:** superseded in part — see `AUDIT_0.1.1.md`, which records an
independent external audit that found four defects introduced *by* this
release's own remediation.
